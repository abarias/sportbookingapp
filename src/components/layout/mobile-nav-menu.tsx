...
export function MobileNavMenu({ navItems, adminItems, showAdminItems, sessionControls }: MobileNavMenuProps) {
  ...
  return (
    <div ref={menuRef} className="relative md:hidden">
      ...
      {isOpen ? (
        <div
          className="absolute right-0 mt-3 w-[min(82vw,22rem)] rounded-3xl border border-white/10 bg-stone-950 p-4 text-sm text-stone-300 shadow-2xl shadow-black/50"
          onClick={(event) => {
